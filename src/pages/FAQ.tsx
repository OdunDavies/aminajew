...
const faqs = [
  ...
  { q: "What payment methods do you accept?", a: "We accept all major payment methods through our secure Paystack payment system — cards (Visa, Mastercard, Verve), bank transfers, and USSD." },
